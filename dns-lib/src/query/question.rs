...
impl Question {
    #[inline]
    pub const fn new(qname: DomainVec, qtype: RType, qclass: RClass) -> Question {
        Question {
    ...
    pub fn with_new_qname(&self, qname: DomainVec) -> Self {
        Question {
            qname: CompressibleDomainVec(qname),
            qtype: self.qtype,
            qclass: self.qclass,
    ...
    pub fn with_new_qname_qtype(&self, qname: DomainVec, qtype: RType) -> Self {
        Question {
            qname: CompressibleDomainVec(qname),
            qtype,
            qclass: self.qclass,
    ...
    pub fn with_new_qname_qclass(&self, qname: DomainVec, qclass: RClass) -> Self {
        Question {
            qname: CompressibleDomainVec(qname),
            qtype: self.qtype,
            qclass,
