...
impl<'a> Display for TokenizerError<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::OriginUsedBeforeDefined => write!(f, "the origin '@' was used before it was defined with '$ORIGIN'"),
            Self::BlankDomainUsedBeforeDefined => write!(f, "a resource record that refers to the last domain name was used without a previous domain name being defined"),
            Self::BlankClassUsedBeforeDefined => write!(f, "a resource record that refers to the last rclass was used without a previous rclass being defined"),
            Self::BlankTTLUsedBeforeDefined => write!(f, "a resource record that refers to the last ttl was used without a previous ttl being defined"),
