...
mod test_text_tokens {
    ...
    gen_ok_test!(test_text_newline_separated_tabs, "\t\n\t", [TextToken::Separator("\t"), TextToken::NewLine("\n"), TextToken::Separator("\t")]);
    gen_ok_test!(test_text_newline_separated_spaces, " \n ", [TextToken::Separator(" "), TextToken::NewLine("\n"), TextToken::Separator(" ")]);

    gen_ok_test!(test_text_literal_escaped_chars, r"\a\b\c\d\e\f\g\h\i\j\k\l\m\n\o\p\q\r\s\t\u\v\w\x\y\z\ \!\@\#\$\%\^\&\*\(\)\{\}\[\]\|\\\:\;\'\~\`", [TextToken::TextLiteral(r"\a\b\c\d\e\f\g\h\i\j\k\l\m\n\o\p\q\r\s\t\u\v\w\x\y\z\ \!\@\#\$\%\^\&\*\(\)\{\}\[\]\|\\\:\;\'\~\`")]);
    gen_ok_test!(test_text_literal_octal_chars, r"\000\001\002\003\004\005\006\007\010\011\376\377", [TextToken::TextLiteral(r"\000\001\002\003\004\005\006\007\010\011\376\377")]);

    gen_ok_test!(test_text_quoted_literal_escaped_chars, "\"\\a\\b\\c\\d\\e\\f\\g\\h\\i\\j\\k\\l\\m\\n\\o\\p\\q\\r\\s\\t\\u\\v\\w\\x\\y\\z\\ \\!\\@\\#\\$\\%\\^\\&\\*\\(\\)\\{\\}\\[\\]\\|\\\\\\:\\;\\'\\~\\`\"", [TextToken::QuotedTextLiteral(r"\a\b\c\d\e\f\g\h\i\j\k\l\m\n\o\p\q\r\s\t\u\v\w\x\y\z\ \!\@\#\$\%\^\&\*\(\)\{\}\[\]\|\\\:\;\'\~\`")]);
    gen_ok_test!(test_text_quoted_literal_octal_chars, "\"\\000\\001\\002\\003\\004\\005\\006\\007\\010\\011\\376\\377\"", [TextToken::QuotedTextLiteral(r"\000\001\002\003\004\005\006\007\010\011\376\377")]);
