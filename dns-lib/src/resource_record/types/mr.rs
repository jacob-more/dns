...
impl MR {
    #[inline]
    pub fn new(new_domain_name: DomainVec) -> Self {
        Self {
    ...
    #[inline]
    pub fn mailbox_rename_domain_name(&self) -> &DomainVec {
...
mod tokenizer_tests {
    ...
    gen_ok_record_test!(
        ...
        MR,
        MR {
            new_domain_name: CompressibleDomainVec(DomainVec::from_utf8(GOOD_DOMAIN).unwrap())
        },
        [GOOD_DOMAIN]
    );
