...
impl PTR {
    #[inline]
    pub fn new(ptr_domain_name: DomainNameVec) -> Self {
        Self {
    ...
    #[inline]
    pub fn ptr_domain_name(&self) -> &DomainNameVec {
...
mod tokenizer_tests {
    ...
    gen_ok_record_test!(
        ...
        PTR,
        PTR {
            ptr_domain_name: CompressibleDomainVec(DomainNameVec::from_utf8(GOOD_DOMAIN).unwrap())
        },
        [GOOD_DOMAIN]
    );
