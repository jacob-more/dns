...
use crate::{resource_record::time::Time, types::c_domain_name::CDomainName};
...
mod tokenizer_tests {
    ...
    gen_fail_record_test!(
        ...
        SOA,
        [GOOD_DOMAIN, GOOD_DOMAIN, GOOD_INTEGER, GOOD_INTEGER]
    );
    gen_fail_record_test!(
        test_fail_three_tokens,
        SOA,
        [GOOD_DOMAIN, GOOD_DOMAIN, GOOD_INTEGER]
    );
